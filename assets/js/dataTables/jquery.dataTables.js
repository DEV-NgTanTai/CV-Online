...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 *    'display index' if you have hidden data Account
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to readily specify the Account in the length drop
		 ...
		 * (i.e. "Xem 1 tới 10 của 57 Tài Khoảng") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Xem _START_ to _END_ of _TOTAL_ Account
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Xem page _PAGE_ of _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Xem _START_ to _END_ of _TOTAL_ Tài Khoản",
			 ...
			 *  @type string
			 *  @default Xem 0 to 0 of 0 Account
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "No Account to show"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoEmpty": "Xem 0 to 0 of 0 Account",
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ total Account)
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtered from _MAX_ total Account)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Show _MENU_ Account",
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Xem x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
